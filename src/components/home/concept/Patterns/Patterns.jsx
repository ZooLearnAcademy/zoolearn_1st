...
const Patterns = ({ activeTab, setActiveTab, setPatternsProgress }) => {
  ...
  useEffect(() => {
    if (setPatternsProgress) {
      setPatternsProgress({
        current: currentIndex + 1,
        total: tabKeys.length
      });
    }
  }, [currentIndex, tabKeys.length, setPatternsProgress]);
  ...
  return (
    <>
      ...
      <div className="patt-zoo-app-container">
        ...
        <div className="patt-zoo-main-content" style={{ marginLeft: 0 }}>
