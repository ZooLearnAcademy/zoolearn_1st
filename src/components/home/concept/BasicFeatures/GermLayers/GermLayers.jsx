...
const LAYERS_INFO = {
  Ectoderm: { 
    color: "#93c5fd", 
    role: "Outermost layer; forms the skin, nervous system, hair, nails, and teeth" 
  },
  Mesoderm: { 
    color: "#fca5a5", 
    role: "Middle layer; forms muscles, bones, the heart, and other internal organs" 
  },
  Endoderm: { 
    color: "#fcd34d", 
    role: "Innermost layer; forms the lining of the digestive tract and organs such as the lungs and liver" 
  },
  Mesoglea: { 
    color: "#e9d5ff", 
    role: "Non-cellular jelly-like layer between Ectoderm and Endoderm" 
  },
  Cavity: { 
    color: "#fff", 
      ...
      <div className="gl-germ-container">
        ...
        <div className="gl-germ-definitions-area">
          ...
          <div className="gl-def-card gl-main-def">
            ...
            <p className="gl-def-intro">Germ layers are the primary embryonic cell layers formed during early development. They give rise to all the tissues and organs of the adult animal. Based on the number of germ layers, animals are classified as diploblastic or triploblastic.</p>
            <ul className="gl-def-list">
              <li>
                <span className="gl-dot gl-ecto"></span>
                <strong>Ectoderm:</strong> Outermost layer; forms the skin, nervous system, hair, nails, and teeth.
              </li>
              <li>
                <span className="gl-dot gl-meso"></span>
                <strong>Mesoderm:</strong> Middle layer; forms muscles, bones, the heart, and other internal organs.
              </li>
              <li>
                <span className="gl-dot gl-endo"></span>
                <strong>Endoderm:</strong> Innermost layer; forms the lining of the digestive tract and organs such as the lungs and liver.
              </li>
            </ul>
          </div>
          ...
          <div className="gl-def-card gl-type-def">
            ...
            <div className="gl-type-block">
              ...
              <p>Diploblastic animals develop from two germ layers—the <strong>ectoderm</strong> and <strong>endoderm</strong>. A non-cellular jelly-like layer called <strong>mesoglea</strong> lies between them instead of a true mesoderm. Examples: Cnidarians (Coelenterates) and Ctenophores.</p>
            </div>
            ...
            <div className="gl-type-block">
              ...
              <p>Triploblastic animals develop from three germ layers—the <strong>ectoderm</strong>, <strong>mesoderm</strong>, and <strong>endoderm</strong>. The presence of the mesoderm allows the development of complex tissues, organs, and organ systems. Examples: Animals from Platyhelminthes to Chordates.</p>
            </div>
          </div>
