      ...
      <div className="proto-content-row proto-slide-in proto-delay-1">
        <div className="proto-row-content proto-bg-protostome proto-hover-card" data-label="PROTOSTOME">
          ...
          <div className="proto-info-box">
            In protostomous animals, during early embryonic development, the first opening formed in the embryo (called the <strong>blastopore</strong>) becomes the <strong>mouth</strong>.
            The anus forms later, at another place.
          </div>
          <div className="proto-info-box">
            These animals usually show simpler to moderately complex body organization and belong mostly to one major evolutionary line.
            Examples include flatworms, roundworms, annelids, arthropods, and molluscs.
          </div>
        ...
        <div className="proto-row-content proto-bg-deuterostome proto-hover-card" data-label="DEUTEROSTOME">
          ...
          <div className="proto-info-box">
            In deuterostomous animals, the first opening of the embryo (blastopore) develops into the
            <strong> anus</strong>.
            The mouth forms later, on the opposite side of the body.
          </div>
          <div className="proto-info-box">
            This pattern is seen in more advanced animals, including those with complex body organization and internal skeletons.
            Examples include echinoderms, hemichordates, and chordates.
          </div>
          <div className="proto-info-box proto-highlight-text">
