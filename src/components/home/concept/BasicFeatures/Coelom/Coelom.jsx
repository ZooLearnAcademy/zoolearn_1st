...
const COELOM_TYPES = [
  {
    ...
    description: "In these animals, the body cavity between the body wall and the alimentary canal is absent. The space between them is filled with mesodermal tissue called parenchyma. The absence of a body cavity means that the internal organs are embedded within this tissue. Examples: Platyhelminthes (flatworms).",
  ...
  },
  {
    ...
    description: "These animals possess a body cavity called a pseudocoelom, but it is not completely lined by mesoderm. The mesoderm is present as scattered pouches between the ectoderm and endoderm. The pseudocoelomic fluid provides space for internal organs, helps in the transport of nutrients, and acts as a hydrostatic skeleton. Examples: Aschelminthes (Nematoda or roundworms).",
  ...
  },
  {
    ...
    description: "These animals possess a true coelom that is completely lined by mesodermal epithelium called the peritoneum.",
      ...
      <div className="coelom-container">
        ...
        <header className="coelom-header">
          ...
          <p className="coelom-intro">
            The coelom is a fluid-filled body cavity located between the body wall and the wall of the alimentary canal. It provides space for the internal organs and is an important feature used in the classification of triploblastic animals. A true coelom is completely lined by tissue derived from the <strong>mesoderm</strong>.
          </p>
        </header>
