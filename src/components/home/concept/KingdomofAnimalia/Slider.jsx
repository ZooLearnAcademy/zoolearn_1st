...
const phylaData = [
  { id: 1, title: "PHYLUM 1", name: "Porifera", des: "Commonly known as sponges. These are primitive, multicellular, marine animals with a porous body that filters water to obtain food and oxygen.", img: "https://res.cloudinary.com/duibfmcw1/image/upload/v1772439559/Picsart_26-03-02_13-18-10-812_kopw6a.png", theme: "#fbbf24" },
  { id: 2, title: "PHYLUM 2", name: "Coelenterata", des: "Also known as Cnidaria (like Jellyfish and Corals). They are aquatic, mostly marine, with tentacles equipped with stinging cells called cnidoblasts.", img: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b5/Jellyfish_transparent_background.png/512px-Jellyfish_transparent_background.png", theme: "#3b82f6" },
  { id: 3, title: "PHYLUM 3", name: "Ctenophora", des: "Commonly known as sea walnuts or comb jellies. They are exclusively marine and move using eight external rows of ciliated comb plates.", img: "https://res.cloudinary.com/duibfmcw1/image/upload/v1772444020/ctenophora_s9hfet.png", theme: "#c084fc" },
  { id: 4, title: "PHYLUM 4", name: "Platyhelminthes", des: "The flatworms. They have a dorso-ventrally flattened body and are mostly endoparasites found in animals, including humans.", img: "https://res.cloudinary.com/duibfmcw1/image/upload/v1772610227/platyhel-removebg-preview_nek7fh.png", theme: "#ef4444" },
