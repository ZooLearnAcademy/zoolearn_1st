...
import Phylum10Data from "./Phylum10Data.json";
import "./Phylum10.css";

const Phylum10 = () => {
  const { slug } = useParams();
  const species = Phylum10Data[slug];

  const speciesKeys = Object.keys(Phylum10Data);
  ...
  const prevSpecies = Phylum10Data[prevSpeciesKey];
  const nextSpecies = Phylum10Data[nextSpeciesKey];
  ...
  const schema = {
    ...
    "url": `https://zoolearn.in/zoohub/hemichordata/${slug}`
  };
  ...
  return (
    <>
      <SEO 
        ...
        description={species.description}
        keywords={`${species.name}, ${species.scientificName}, Hemichordata, Zoology, Animal Kingdom`}
        canonicalUrl={`/zoohub/hemichordata/${slug}`}
        schema={schema}
      />
      ...
      <div className="phyl-hero">
        ...
        <div className="phyl-hero-nav">
          <div className="phyl-hero-nav">
          <Link to={`/zoohub/hemichordata/${prevSpecies.slug}`} className="phyl-nav-btn prev">
          ...
          <Link to={`/zoohub/hemichordata/${nextSpecies.slug}`} className="phyl-nav-btn next">
            <div className="nav-text">
