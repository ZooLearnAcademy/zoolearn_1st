...
import Phylum7Data from "./Phylum7Data.json";
import "./Phylum7.css";

const Phylum7 = () => {
  const { slug } = useParams();
  const species = Phylum7Data[slug];

  const speciesKeys = Object.keys(Phylum7Data);
  ...
  const prevSpecies = Phylum7Data[prevSpeciesKey];
  const nextSpecies = Phylum7Data[nextSpeciesKey];
  ...
  const schema = {
    ...
    "url": `https://zoolearn.in/zoohub/arthropoda/${slug}`
  };
  ...
  return (
    <>
      <SEO 
        ...
        description={species.description}
        keywords={`${species.name}, ${species.scientificName}, Arthropoda, Zoology, Animal Kingdom`}
        canonicalUrl={`/zoohub/arthropoda/${slug}`}
        schema={schema}
      />
      ...
      <div className="phyl-hero">
        ...
        <div className="phyl-hero-nav">
          <div className="phyl-hero-nav">
          <Link to={`/zoohub/arthropoda/${prevSpecies.slug}`} className="phyl-nav-btn prev">
          ...
          <Link to={`/zoohub/arthropoda/${nextSpecies.slug}`} className="phyl-nav-btn next">
            <div className="nav-text">
