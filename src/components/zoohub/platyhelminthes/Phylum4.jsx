...
import Phylum4Data from "./Phylum4Data.json";
import "./Phylum4.css";

const Phylum4 = () => {
  const { slug } = useParams();
  const species = Phylum4Data[slug];

  const speciesKeys = Object.keys(Phylum4Data);
  ...
  const prevSpecies = Phylum4Data[prevSpeciesKey];
  const nextSpecies = Phylum4Data[nextSpeciesKey];
  ...
  const schema = {
    ...
    "url": `https://zoolearn.in/zoohub/platyhelminthes/${slug}`
  };
  ...
  return (
    <>
      <SEO 
        ...
        description={species.description}
        keywords={`${species.name}, ${species.scientificName}, Platyhelminthes, Zoology, Animal Kingdom`}
        canonicalUrl={`/zoohub/platyhelminthes/${slug}`}
        schema={schema}
      />
      ...
      <div className="phyl-hero">
        ...
        <div className="phyl-hero-nav">
          <div className="phyl-hero-nav">
          <Link to={`/zoohub/platyhelminthes/${prevSpecies.slug}`} className="phyl-nav-btn prev">
          ...
          <Link to={`/zoohub/platyhelminthes/${nextSpecies.slug}`} className="phyl-nav-btn next">
            <div className="nav-text">
