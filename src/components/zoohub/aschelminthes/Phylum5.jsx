...
import Phylum5Data from "./Phylum5Data.json";
import "./Phylum5.css";

const Phylum5 = () => {
  const { slug } = useParams();
  const species = Phylum5Data[slug];

  const speciesKeys = Object.keys(Phylum5Data);
  ...
  const prevSpecies = Phylum5Data[prevSpeciesKey];
  const nextSpecies = Phylum5Data[nextSpeciesKey];
  ...
  const schema = {
    ...
    "url": `https://zoolearn.in/zoohub/aschelminthes/${slug}`
  };
  ...
  return (
    <>
      <SEO 
        ...
        description={species.description}
        keywords={`${species.name}, ${species.scientificName}, Aschelminthes, Zoology, Animal Kingdom`}
        canonicalUrl={`/zoohub/aschelminthes/${slug}`}
        schema={schema}
      />
      ...
      <div className="phyl-hero">
        ...
        <div className="phyl-hero-nav">
          <div className="phyl-hero-nav">
          <Link to={`/zoohub/aschelminthes/${prevSpecies.slug}`} className="phyl-nav-btn prev">
          ...
          <Link to={`/zoohub/aschelminthes/${nextSpecies.slug}`} className="phyl-nav-btn next">
            <div className="nav-text">
