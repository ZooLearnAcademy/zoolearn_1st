...
import Phylum9Data from "./Phylum9Data.json";
import "./Phylum9.css";

const Phylum9 = () => {
  const { slug } = useParams();
  const species = Phylum9Data[slug];

  const speciesKeys = Object.keys(Phylum9Data);
  ...
  const prevSpecies = Phylum9Data[prevSpeciesKey];
  const nextSpecies = Phylum9Data[nextSpeciesKey];
  ...
  const schema = {
    ...
    "url": `https://zoolearn.in/zoohub/echinodermata/${slug}`
  };
  ...
  return (
    <>
      <SEO 
        ...
        description={species.description}
        keywords={`${species.name}, ${species.scientificName}, Echinodermata, Zoology, Animal Kingdom`}
        canonicalUrl={`/zoohub/echinodermata/${slug}`}
        schema={schema}
      />
      ...
      <div className="phyl-hero">
        ...
        <div className="phyl-hero-nav">
          <div className="phyl-hero-nav">
          <Link to={`/zoohub/echinodermata/${prevSpecies.slug}`} className="phyl-nav-btn prev">
          ...
          <Link to={`/zoohub/echinodermata/${nextSpecies.slug}`} className="phyl-nav-btn next">
            <div className="nav-text">
