...
import Phylum6Data from "./Phylum6Data.json";
import "./Phylum6.css";
...
const Phylum6 = () => {
  ...
  const speciesKeys = Object.keys(Phylum6Data);
  ...
  const prevSpecies = Phylum6Data[prevSpeciesKey];
  const nextSpecies = Phylum6Data[nextSpeciesKey];
  ...
  const schema = {
    ...
    "url": `https://zoolearn.in/zoohub/annelida/${slug}`
  };
  ...
  return (
    <>
      <SEO 
        ...
        description={species.description}
        keywords={`${species.name}, ${species.scientificName}, Annelida, Zoology, Animal Kingdom`}
        canonicalUrl={`/zoohub/annelida/${slug}`}
        schema={schema}
      />
      ...
      <div className="phyl-hero">
        ...
        <div className="phyl-hero-nav">
          <div className="phyl-hero-nav">
          <Link to={`/zoohub/annelida/${prevSpecies.slug}`} className="phyl-nav-btn prev">
          ...
          <Link to={`/zoohub/annelida/${nextSpecies.slug}`} className="phyl-nav-btn next">
            <div className="nav-text">
