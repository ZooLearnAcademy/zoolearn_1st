...
import Phylum2Data from "./Phylum2Data.json";
import "./Phylum2.css";

const Phylum2 = () => {
  const { slug } = useParams();
  const species = Phylum2Data[slug];

  const speciesKeys = Object.keys(Phylum2Data);
  ...
  const prevSpecies = Phylum2Data[prevSpeciesKey];
  const nextSpecies = Phylum2Data[nextSpeciesKey];
  ...
  const schema = {
    ...
    "url": `https://zoolearn.in/zoohub/coelenterata/${slug}`
  };
  ...
  return (
    <>
      <SEO 
        ...
        description={species.description}
        keywords={`${species.name}, ${species.scientificName}, Coelenterata, Zoology, Animal Kingdom`}
        canonicalUrl={`/zoohub/coelenterata/${slug}`}
        schema={schema}
      />
      ...
      <div className="phyl-hero">
        ...
        <div className="phyl-hero-nav">
          <div className="phyl-hero-nav">
          <Link to={`/zoohub/coelenterata/${prevSpecies.slug}`} className="phyl-nav-btn prev">
          ...
          <Link to={`/zoohub/coelenterata/${nextSpecies.slug}`} className="phyl-nav-btn next">
            <div className="nav-text">
