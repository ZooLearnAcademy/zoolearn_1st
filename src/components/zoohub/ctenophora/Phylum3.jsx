...
const Phylum3 = () => {
  ...
  const species = Phylum3Data[slug];

  const speciesKeys = Object.keys(Phylum3Data);
  ...
  const prevSpecies = Phylum3Data[prevSpeciesKey];
  const nextSpecies = Phylum3Data[nextSpeciesKey];
  ...
  const schema = {
    ...
    "url": `https://zoolearn.in/zoohub/ctenophora/${slug}`
  };
  ...
  return (
    <>
      <SEO 
        ...
        description={species.description}
        keywords={`${species.name}, ${species.scientificName}, Ctenophora, Zoology, Animal Kingdom`}
        canonicalUrl={`/zoohub/ctenophora/${slug}`}
        schema={schema}
      />
      ...
      <div className="phyl-hero">
        ...
        <div className="phyl-hero-nav">
          <div className="phyl-hero-nav">
          <Link to={`/zoohub/ctenophora/${prevSpecies.slug}`} className="phyl-nav-btn prev">
          ...
          <Link to={`/zoohub/ctenophora/${nextSpecies.slug}`} className="phyl-nav-btn next">
            <div className="nav-text">
