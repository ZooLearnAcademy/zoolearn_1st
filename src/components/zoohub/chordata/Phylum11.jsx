...
import Phylum11Data from "./Phylum11Data.json";
import "./Phylum11.css";

const Phylum11 = () => {
  const { slug } = useParams();
  const species = Phylum11Data[slug];

  const speciesKeys = Object.keys(Phylum11Data);
  ...
  const prevSpecies = Phylum11Data[prevSpeciesKey];
  const nextSpecies = Phylum11Data[nextSpeciesKey];
  ...
  const schema = {
    ...
    "url": `https://zoolearn.in/zoohub/chordata/${slug}`
  };
  ...
  return (
    <>
      <SEO 
        ...
        description={species.description}
        keywords={`${species.name}, ${species.scientificName}, Chordata, Zoology, Animal Kingdom`}
        canonicalUrl={`/zoohub/chordata/${slug}`}
        schema={schema}
      />
      ...
      <div className="phyl-hero">
        ...
        <div className="phyl-hero-nav">
          <div className="phyl-hero-nav">
          <Link to={`/zoohub/chordata/${prevSpecies.slug}`} className="phyl-nav-btn prev">
          ...
          <Link to={`/zoohub/chordata/${nextSpecies.slug}`} className="phyl-nav-btn next">
            <div className="nav-text">
