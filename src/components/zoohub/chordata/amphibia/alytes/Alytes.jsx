...
const Grantia = () => {
  ...
  <ul>
    <li>
      <a data-level="Kingdom">Animalia</a>
      <ul>
        <li>
          <a data-level="Phylum">Nematoda</a>
          <ul>
            <li>
              <a data-level="Class">Secernentea</a>
              <ul>
                <li>
                  <a data-level="Order">Ascaridida</a>
                  <ul>
                    <li>
                      <a data-level="Family">Ascarididae</a>
                      <ul>
                        <li>
                          <a data-level="Genus">Ascaris</a>
                          <ul>
                            <li>
                              <a data-level="Species">Ascaris lumbricoides</a>
                            </li>
                          </ul>
                        </li>
                      </ul>
