    ...
    <div className="genus-sycon-container">
      ...
      <div className="hero">
        <div className="hero-content">
          <div className="hero-text">
            <h1>Doliolum</h1>
            <p>
              <b>Doliolum</b>is a small pelagic tunicate.Shows complex polymorphism.Common in plankton.
            </p>
          </div>
          <div className="hero-image">
            <img src="https://res.cloudinary.com/duibfmcw1/image/upload/v1767895311/Doliolum_kcjpas.png" alt="Doliolum" />
          </div>
        </div>
      </div>
      ...
      <section className="content-section">
        ...
        <div className="card">
          <h2>📌 Introduction</h2>
          <ul>
            <li>Doliolum inhabits open seas.</li>
            <li>Pelagic and filter-feeding.</li>
            <li>Important for studying life cycles.</li>
          </ul>
        </div>
        ...
        <div className="card">
          ...
          <div className="side-by-side">
            <div>
              <ul>
                <li>Small barrel-shaped body</li>
                <li>Transparent tunic</li>
                <li>Muscular rings present</li>
                <li>Free-swimming</li>
              </ul>
            </div>
            ...
            <ul>
                ...
                <ul>
                    ...
                    <ul>
                        ...
                        <ul>
                            <li><a data-level="Order">Doliolida</a>
                            <ul>
                                <li><a data-level="Family">Doliolidae</a>
                                <ul><li><a data-level="Genus">Doliolum</a></li></ul>
                                </li>
                            </ul>
                            </li>
                        </ul>
        ...
        <div className="card">
          ...
          <ul>
            <li>Planktonic filter feeder</li>
            <li>Nutrient cycling</li>
            <li>Part of marine plankton</li>
          </ul>
        </div>
        ...
        <div className="card">
          ...
          <ul>
            <li>Ocean productivity indicator</li>
            <li>Research on polymorphism</li>
