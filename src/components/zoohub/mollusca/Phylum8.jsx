...
const Phylum8 = () => {
  ...
  const speciesKeys = Object.keys(Phylum8Data);
  ...
  const prevSpecies = Phylum8Data[prevSpeciesKey];
  const nextSpecies = Phylum8Data[nextSpeciesKey];
  ...
  const schema = {
    ...
    "url": `https://zoolearn.in/zoohub/mollusca/${slug}`
  };
  ...
  return (
    <>
      <SEO 
        ...
        description={species.description}
        keywords={`${species.name}, ${species.scientificName}, Mollusca, Zoology, Animal Kingdom`}
        canonicalUrl={`/zoohub/mollusca/${slug}`}
        schema={schema}
      />
      ...
      <div className="phyl-hero">
        ...
        <div className="phyl-hero-nav">
          <div className="phyl-hero-nav">
          <Link to={`/zoohub/mollusca/${prevSpecies.slug}`} className="phyl-nav-btn prev">
          ...
          <Link to={`/zoohub/mollusca/${nextSpecies.slug}`} className="phyl-nav-btn next">
            <div className="nav-text">
